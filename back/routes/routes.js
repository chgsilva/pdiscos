...
module.exports = function(app) {
    ...
    app.delete(PREFIX + '/artist/:id_artist', app.controllers.catalogoController.deteleArtist);
    ...
    app.delete(PREFIX + '/album/:id_album', app.controllers.catalogoController.deteleAlbum);

    app.get(PREFIX + '/albumsByArtist/:id_artist', app.controllers.catalogoController.albumsByArtist);
    app.get(PREFIX + '/albumsByCollection/:id_collection', app.controllers.catalogoController.albumsByCollection);
    ...
    app.delete(PREFIX + '/collection/:id_collection', app.controllers.catalogoController.deteleCollection);
